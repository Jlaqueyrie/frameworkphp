    ...
    <div class="col mt-5">
        <div class="card card-body bg-light mt-5">
            ...
            <form action="<?= URLROOT ?>/ursers/register" method="post">
                ...
                <div class="row">
                    <div class="col">
                        <a href="<?= URLROOT?>users/register" class="btn btn-success btn-block">Se connecter</a>
                    </div>
                    <div class="col">
                        <a href="<?= URLROOT?>users/login" class="btn btn-light btn-block">Pas encore inscrit, inscrivez vous</a>
                    </div>
                </div>
            </form>
        </div>
